...
public class Ventana extends JFrame {
    ...
    private JLabel lblDesarrolladore;
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(143, 226, 86));
        lblId = new JLabel("Id: ");
        ...
        lblDesarrolladore = new JLabel("Desarrollador: ");
        txtDesarrollador = new JTextField(25);
        panel1.add(lblDesarrolladore);
        ...
        panel2.setBackground(new Color(232, 87, 228));
        info = new ArrayList<>();
